...
export default function About() {
  return (
    <>
      <main className="py-20 px-6 min-h-screen bg-gradient-to-b from-[#0f172a] to-[#1e293b]">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="text-xl text-gray-400 leading-relaxed">
            ...
            worked on diverse projects—from online booking platforms to
            AI-powered educational tools—using technologies like React, Next.js,
            .NET Core, Prisma, and MongoDB.
          </p>
          ...
          <p className="mt-4 text-xl text-gray-400 leading-relaxed">
            ...
            implementing seamless payment systems with Stripe or building
            scalable APIs, I take pride in writing code that delivers real
            value.
          </p>

          <p className="mt-4 text-xl text-gray-400 leading-relaxed">
            Currently, I’m looking for exciting opportunities where I can grow
            as a developer, contribute to meaningful projects, and be part of a
            team that values creativity, learning, and innovation.
          </p>
